        ...
        <tbody>
            <c:forEach var="fproduct" items="${myProducts}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/farm/product/detail/${fproduct.pcode}?page=${page}&searchKeyword=${param.searchKeyword}" style="display: block; color: inherit; text-decoration: none; white-space: nowrap; overflow: hidden; text-overflow: ellipsis;">${fproduct.pname}</a>
                    </td>
