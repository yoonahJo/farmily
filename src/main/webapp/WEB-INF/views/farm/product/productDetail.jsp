...
<head>
    ...
    <style>
        ...
        .main-image {
            width: 100%;
            height: 100%;
           /*  object-fit: contain; 이미지의 비율을 유지하며 컨테이너에 맞게 조정 */
            object-fit: cover;
            position: absolute;
            top: 0;
            left: 0;
...
<div class="container my-5">
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            ...
            <div class="mt-4">
                <a href="${pageContext.request.contextPath}/farm/product/updatePage/${product.pcode}?page=${param.page}&searchKeyword=${param.searchKeyword}" class="btn btn-success">수정</a>
                
                <a href="${pageContext.request.contextPath}/farm/product?page=${param.page}&searchKeyword=${param.searchKeyword}" class="btn btn-success">목록</a>
                <a href="${pageContext.request.contextPath}/farm/product/delete?pcode=${product.pcode}" class="btn btn-danger" onclick="return confirm('정말로 삭제하시겠습니까?');">삭제</a>
