...
<div class="d-flex justify-content-center">		
	<div class="container mt-5 col-lg-5 p-0" >
  		<ul class="nav nav-tabs nav-justified ">
    		<li class="nav-item">
      			<a class="nav-link text-secondary" href="./findId">아이디 찾기</a>
    		</li>
    		<li class="nav-item">
      			<a class="nav-link active text-success" href="./findPw">비밀번호 찾기</a>
    		</li>
  		</ul>
  		<div id="findbody" >
  		<p class="fw-bold fs-3 my-4 text-center">비밀번호 찾기</p>
			<form action="/findPw" method="post" onsubmit="findPw(event)">				
				...
				<div class="form-floating my-3 position-relative">
					 <input type="text" class="form-control" name="id" id="floatingId" required>
		...
		<!-- The Modal -->
				<div class="modal" id="myModal">
				  <div style="max-width: 520px; top: 20%; right: 0.6%" class="modal-dialog">
					  	...
					  	$.ajax({
							...
							success: function(data){
								...
								if(data){
									...
									$(document).ready(function (){
										$("#modalMessage").text("입력한 정보와 일치하는 회원이 없습니다.");
							            $("#myModal").modal("show");
							        });
								}
							},
