			...
			<div style="max-width: 800px;" class="container">
				<nav class="mx-1 border-bottom-0">
					<div class="nav nav-tabs border-bottom-0" id="nav-tab" role="tablist">
					    <button style="max-width: 242px; height: 60px;" class="w-50 nav-link active border-bottom-0 text-black" id="nav-home-tab" data-bs-toggle="tab" data-bs-target="#nav-home" type="button" role="tab" aria-controls="nav-home" aria-selected="true">일반 로그인</button>
					    <button style="max-width: 242px; height: 60px;" class="w-50 nav-link border-bottom-0 text-black" id="nav-profile-tab" data-bs-toggle="tab" data-bs-target="#nav-profile" type="button" role="tab" aria-controls="nav-profile" aria-selected="false">농부 로그인</button>
					</div>
				</nav>	
				 	...
				 	<form class="p-3 mx-1 rounded-1 shadow-lg mb-5 border border-1" method="post" action="/login" id="loginform">
						<div class="mt-3 mt-sm-0 p-0">
							...
							<div class="d-block d-sm-flex  justify-content-sm-between mt-4 mb-2">
								<div>
									<a class=" d-flex justify-content-center p-0" href="https://kauth.kakao.com/oauth/authorize?response_type=code&client_id=f6a352809611dcbedb271d56ff68d255&redirect_uri=http://localhost:8080/kakao/login">
										<img class="socialImg rounded-3 w-100 h-100" src="${pageContext.request.contextPath}/img/kakao-login.png" title="logo" alt="logo"/>
									</a>
								</div>
								<div class="mt-2 mt-sm-0">
									<a href="#" id="naverLogin" class="d-flex justify-content-center p-0">
										<img class="socialImg rounded-3 w-100 h-100" src="${pageContext.request.contextPath}/img/naver-login.png" title="logo" alt="logo"/>
									</a>
								</div>
							</div>
